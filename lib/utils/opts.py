...
class opts(object):
    def __init__(self):
        ...
        # save
        self.parser.add_argument('--save_dir', type=str, default='./weight',
                                 help='savepath of model.')

        # dataset
        self.parser.add_argument('--datasetname', type=str, default='rsdata',
                                 help='dataset name.')
        self.parser.add_argument('--data_dir', type=str, default= '/home/public/RsCarData/',
    ...
    def parse(self, args=''):
        ...
        opt.dataName = opt.data_dir.split('/')[-1]
