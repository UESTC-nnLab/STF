...
def test(opt, split, modelPath, show_flag, results_name, saveMat=False):
    ...
    model = get_det_net({'hm': dataset.num_classes, 'wh': 2, 'reg': 2}, 'STFNet')# 建立模型
    ...
    if saveMat:
        save_mat_path_upper = os.path.join('/home/zsc/2_STFNet/STFNet/result/ablation/', results_name+'_mat')
...
if __name__ == '__main__':
    ...
    if opt.load_model != '':
        ...
        modelPath = '/home/zsc/2_STFNet/STFNet/weight/rsdata/STFNet/weights2024_07_18_12_21_15/682.pth'
